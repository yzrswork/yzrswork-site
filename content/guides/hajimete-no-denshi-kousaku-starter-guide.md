...
**追記（2026-07-28）**: この工程で紹介している工具を、チェックリスト形式でまとめたツールを作りました。買い揃える順番に迷ったらこちらもどうぞ。 - [装備ナビ — Maker's Starter Kit](https://apps.yzrswork.com/kit/?yzrs_ref=guide01-kit)
...
温度設定やこて先の状態、うまく付かない原因をその場で確認したいときは、[はんだ付けナビ](https://apps.yzrswork.com/handa/?yzrs_ref=guide01-handa)も使えます。
...
LEDの抵抗値を電源電圧から確認したいときは、[LED抵抗計算ツール](https://apps.yzrswork.com/bench/?yzrs_ref=guide01-bench)でその場で計算できます。
...
- [装備ナビ — Maker's Starter Kit](https://apps.yzrswork.com/kit/?yzrs_ref=guide01-kit)（本記事の工具リストをチェックリスト化したツール）
